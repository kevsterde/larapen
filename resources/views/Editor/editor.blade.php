...
<div class="w-full h-[80vh] flex flex-col gap-5">
    <div>
        <div class="flex justify-between gap-5">
            <div class="w-full relative pt-9">
               <div class="absolute w-full top-0 left-0 right-0"> <h2 class="text-xl text-white font-bold inline-block">HTML</h2></div>
                <textarea class="px-5 box-border w-full min-h-32 h-full bg-primaryColor bg-opacity-50 text-white"></textarea> 
            </div>
            <div class="w-full relative pt-9">
               <div class="absolute w-full top-0 left-0 right-0"> <h2 class="text-xl text-white font-bold inline-block">CSS</h2></div>
                <textarea class="px-5 box-border w-full min-h-32 h-full bg-primaryColor bg-opacity-50 text-white"></textarea> 
            </div>
            <div class="w-full relative pt-9">
                <div class="absolute w-full top-0 left-0 right-0"> <h2 class="text-xl text-white font-bold inline-block">Javascript</h2></div>
                 <textarea class="px-5 box-border w-full min-h-32 h-full bg-primaryColor bg-opacity-50 text-white"></textarea> 
             </div>
        </div>
    </div>
    ...
    <div class="w-full h-full bg-white">
        <iframe id="editor-output" class="w-full h-full"></iframe>
    </div>
